    ...
    <div className="flex min-h-screen flex-col mt-2 mx-7">
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex  justify-between itmes-center w-[50%]">
          ...
          <div className="flex-shrink w-[75%] mt-[-.5rem]">
...
//           </div>
//         </div>
//         <Input onChange={handleChange} name="title" className="sm:w-[100%] border-none p-8 text-[4rem] text-left font-medium mt-10 w-full" placeholder="Title" />
//         <div className="flex flex-wrap justify-between items-center w-full lg:w-[50%] mt-11">
//           <div className="flex gap-8 mb-11">
//             <Image alt="" width={25} height={25} src="/sunny.png" />
//             <div>Status</div>
//           </div>
...
//           </div>
//         </div>
//         <div className="flex sm:w-[100%] flex-wrap justify-between items-center w-full lg:w-[50%]">
//           <div className="flex gap-8 mb-11">
//             <Image alt="" width={25} height={25} src="/diamond-exclamation.png" />
//             <div>Priority</div>
//           </div>
//           <div className="flex-shrink w-full lg:w-[75%] mt-[-.5rem]">
//             <Select onValueChange={handleSelectChange}>
...
//           </div>
//         </div>
//         <div className="flex flex-wrap justify-between items-center w-full lg:w-[50%]">
//           <div className="flex gap-8 mb-11">
//             <Image alt="" width={25} height={25} src="/calendar.png" />
//             <div>Deadline</div>
//           </div>
//           <div className="w-full lg:w-[75%] mt-[-.5rem]">
//             <Input
//               type="date"
//               name="deadline"
//               onChange={handleDateChange}
...
//           </div>
//         </div>
//         <Button type="submit" className="bg-gradient-to-b from-blue-800 to-blue-950 py-7 px-[4rem] rounded-lg text-2xl w-full lg:w-auto">Add</Button>
//       </form>
//     </div>
//   )
// }
